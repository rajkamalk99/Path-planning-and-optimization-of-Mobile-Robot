...
map=int16(imbinarize(imread('/home/raj/Documents/minor_project/final/sample_inputs/map4.bmp'))); % Specify the map to be read
source=[20 250]; % source position in Y, X format
goal=[480 250]; % goal position in Y, X format
robotDirection=pi/4; % initial heading direction of the robot
robotSize=[10 10]; %length and breadth(The robot dimensions)
robotSpeed=10; % specify the regular speed of the robot
maxRobotSpeed=10; % Specify the maximum speed of the robot
...
fuz=readfis('fuzzyBase.fis'); % fuzzy inference system used.
